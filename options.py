...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--val_txt', type=str, default ='/data1/rong/code/Eyes/data/txts/val/main1.txt',  help='txt of val data')
        ...
        parser.add_argument('--w2', type=float, default=1.0, help='w2')
